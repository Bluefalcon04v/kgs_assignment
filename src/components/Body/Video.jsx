...
//               </div>
//             </div>
//             <video ref={video} className="playingVideo">
...
//               Voluptates fuga, cumque aliquid iure hic suscipit unde
//               reprehenderit facere quibusdam consectetur voluptatem laborum.
//               Accusamus, nemo.
//             </p>
//           </div>
//         </div>
...
const Video = () => {
  ...
  const [selectedSpeed, setSelectedSpeed] = useState(1);
  const [progressPosition, setProgressPosition] = useState(0);
  // const [playingVideo, setPlayingVideo] = useState(Video_1); 
        ...
        <div className="videoSection">
          <div className="videoContainer" ref={videoContainer}>
            ...
            <video key={playingVideo} ref={video} className="playingVideo">
              {/* {playingVideo && <source src={playingVideo} type="video/mp4" />} */}
              <source src={playingVideo} type="video/mp4" />
            </video>
          </div>
          <div className="videoContentContainer">
          <h2 className="heading">{cardContent ? cardContent.heading : ""}</h2>
            <p className="para">
